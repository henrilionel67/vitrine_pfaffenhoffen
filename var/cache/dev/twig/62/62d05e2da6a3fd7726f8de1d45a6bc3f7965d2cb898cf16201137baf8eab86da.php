...
class __TwigTemplate_44df4d870b89dd4806fe02b242b90811c5c40a4660dbe34ab700ad8fa4fb0de1 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        <small style=\"color: #C82829\">";
        // line 13
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 13, $this->source); })()), "plainPassword", [], "any", false, false, false, 13), "first", [], "any", false, false, false, 13), 'errors');
        echo "</small>
        ...
        <button type=\"submit\" class=\"btn btn-outline-primary\" style=\"margin-top: 20px;padding-left: 30px;padding-bottom: 10px;padding-top: 10px;padding-right: 30px;\">Register!</button>
        ";
        // line 20
...
";
    ...
    {
        return array (  125 => 20,  118 => 16,  114 => 15,  109 => 13,  105 => 12,  100 => 10,  96 => 9,  91 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    <div style=\"padding-left: 20%; padding-right: 20%; padding-top: 5%\">
        ...
        <small style=\"color: #C82829\">{{ form_errors(form.email) }}</small>
        <i class=\"fas fa-lock fa-lg\" style=\"margin-top: 20px\"></i>
        {{ form_widget(form.plainPassword.first, {'attr': { 'class': 'form-control', 'placeholder': 'Password'}}) }}
        <small style=\"color: #C82829\">{{ form_errors(form.plainPassword.first) }}</small>
        <div style=\"margin-top: 20px\">
            {{ form_widget(form.plainPassword.second, {'attr': { 'class': 'form-control', 'placeholder': 'Repeat password'}}) }}
            <small style=\"color: #C82829\">{{ form_errors(form.plainPassword.second) }}</small>
        </div>

        <button type=\"submit\" class=\"btn btn-outline-primary\" style=\"margin-top: 20px;padding-left: 30px;padding-bottom: 10px;padding-top: 10px;padding-right: 30px;\">Register!</button>
        {{ form_end(form) }}
    </div>
{% endblock %}", "registration/register.html.twig", "C:\\Users\\amaur\\Desktop\\vitrine_pfaffenhoffen\\templates\\registration\\register.html.twig");
    }
}
